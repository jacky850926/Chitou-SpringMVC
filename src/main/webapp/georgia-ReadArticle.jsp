<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="tw.georgia.model.* , java.util.*, java.sql.*, javax.servlet.* , javax.naming.*, java.sql.*, javax.sql.*"%>
<%
...
for (Article bean : list) {
		%>
				<tr>
					...
					<td name="bigClassID" class="centre"><%=bean.getBigClassID() %></td>
					<td name="articleClassID" class="centre"><%=bean.getArticleClassID() %></td>
					<td name="title"><%=bean.getTitle() %></td>
					<td name="articleDate" class="centre"><%=bean.getArticleDate() %></td>
