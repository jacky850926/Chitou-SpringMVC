...
<nav class="site-nav" >
		<div class="container" >
			<div class="menu-bg-wrap" style="background-color: lightblue">
				...
				<img src ="images/chitou.png" />
				 <a href="" class="logo m-0 start"> ChiTou </a>
		...
		<div class="hero-slide">
			...
			<div class="img overlay" style="background-image: url('images/image3.jpg')"></div>
		</div>
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center">
					...
					<form action="#" class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up"
						data-aos-delay="200">
						<input type="text" class="form-control px-4" placeholder="輸入目的地、景點、體驗行程或活動名稱....">
						<button type="submit" class="btn btn" style="background-color: lightblue"><i class="fa-solid fa-magnifying-glass"></i></button>
					</form>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row mb-5 align-items-center">
				...
				<div class="col-lg-6 text-lg-end">
					<p><a href="#" target="_blank" class="btn btn-primary text-white py-3 px-4" style="background-color: lightblue">查看更多飯店</a>
					</p>
				</div>
			</div>
						...
						<div class="property-slider">
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 320桃園市中壢區民權路398號</span>
										...
										<a href="" class="btn btn-primary py-2 px-3" style="background-color: lightblue">詳細</a>
									</div>
								</div>
							</div>
			...
			<!-- .item -->
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 110台北市信義區忠孝東路五段10號</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 880澎湖縣馬公市同和路168號</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 2 Chome-1-1 Nihonbashimuromachi, Chuo City, Tokyo 103-8328日本</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 163-1055 東京都 新宿區Nishishinjuku 3-7-1-2 Nishi Shinjuku</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 1 Chome-1-1 Marunouchi, Chiyoda City, Tokyo 100-0005日本</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 400 West 42nd Street, NY 10036</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 140 West 28th Street</span>
										<span class="city d-block mb-3">SpringHill Suites by Marriott New York Manhattan Chelsea</span>
							...
							<div class="property-item">
								...
								<div class="property-content">
									...
									<div>
										<span class="d-block mb-2 text-black-50"><i class="fa-solid fa-location-dot"></i> 481 Eighth Avenue,</span>
			...
			<div class="row mb-5 align-items-center">
				...
				<div class="col-md-6 text-md-end">
					<div id="testimonial-nav">
						<span class="prev" data-controls="prev">往前</span>

						<span class="next" data-controls="next">往後</span>
					</div>
				</div>
			</div>
				...
				<div class="testimonial-slider">
					<div class="item">
						<div class="testimonial">
							<img src="images/xpark.png" alt="Image" class="img-fluid w-100 mb-100">
							<div class="rate">
							<br>
							...
							<blockquote>
								<p>
						Xpark 為台灣首座新都會型水生公園。將生活在地球上各種地域的生物們的環境，透過空間演出與科技的融合，加以忠實的重現。
						...
						從各種角度將其魅力性襯托出來的環境演出也是一大特徵。</p>
							...
							<p class="text-black-50"><i class="fa-solid fa-location-dot"></i> 桃園市中壢區春德路105號</p>
						</div>
					</div>

					<div class="item">
						<div class="testimonial">
							<img src="images/image4.jpg" alt="Image" class="img-fluid w-100 mb-100 ">
							<div class="rate">
														<br>
							...
							<blockquote>
								<p>–七月限定「海洋冰風暴2-冰怪來襲」活動 

									海洋公園獨家暑期限定活動【海洋冰風暴2-冰怪來襲】
									炎熱的夏日即將到來！我們將極凍整個夏天！
									水槍水車激起的水花大戰，帶領大家持續清涼high酷到最高點！</p>
							</blockquote>
							<p class="text-black-50"><i class="fa-solid fa-location-dot"></i> 台灣花蓮縣壽豐鄉189號</p>
						</div>
					</div>

					<div class="item">
						<div class="testimonial">
							<img src="images/image5.jpg" alt="Image" class="img-fluid w-100 mb-100">
							<div class="rate">
														<br>
							...
							陸上的「探索樂園」擁有豐富的刺激設施，吸引眾多遊客前來朝聖，若你喜歡極限挑戰，絕對不能錯過全台唯一的斷軌式雲霄飛車「 搶救地心 」，是雲霄飛車迷必搭的首選設施
							家喻戶曉的馬拉灣水上樂園（夏日限定），園區內擁有 10 項以上的水上設施，如高空快速滑水道「急速勇士」和巨大的 U 型滑板「巫師飛艇」，彎曲的滑道與驚人的高度，令人興奮又期待
							天空之夢為全台最高摩天輪-海拔總高度 384M，約等同台北 101 大樓 88 層觀景台 全台唯一完全由台灣專業團隊負責，無任何外籍技師參與組裝完成的摩天輪，堪稱台灣之光。</p>
							</blockquote>
							<p class="text-black-50"><i class="fa-solid fa-location-dot"></i> 台灣台中市后里區福容路8號</p>
						</div>
					</div>

					<div class="item">
						<div class="testimonial">
							<img src="images/image6.jpg" alt="Image" class="img-fluid  w-100 mb-100">
							<div class="rate">
														<br>
							...
							<blockquote>
								<p>由「 美國大西部 」、「 南太平洋 」、「 阿拉伯皇宮 」以及「 非洲部落 」等四大異國主題村所建構成，
								加上 2012 年推出「六福水樂園」，高達75公頃的廣闊遊樂場域，除了擁有 30 項以上廣受年輕人喜愛的驚險刺激遊樂設施以及適合親子同遊的野生動物園外，
								還有定時演出的音樂水舞秀、媲美迪士尼的大型花車遊行等各項精彩歌舞表演，期望能帶給消費者更多身心靈上的感動與滿足。</p>
							</blockquote>
							<p class="text-black-50"><i class="fa-solid fa-location-dot"></i> 新竹縣關西鎮仁安里拱子溝60號</p>
						</div>
					</div>
	...
	<div class="section">
		<div class="row justify-content-center footer-cta" data-aos="fade-up">
			<div class="col-lg-7 mx-auto text-center">
				...
				<p><a href="#" target="_blank" class="btn btn-primary text-white py-3 px-4" style="background-color: lightblue">加入會員</a></p>
			</div> <!-- /.col-lg-7 -->
		</div> <!-- /.row -->
	</div>
			...
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/dog1.jpg" class="img-responsive" alt="Cinque Terre">

						<div class="person-contents">
							<h2 class="mb-0"><a href="#">組長:李芝宇</a></h2>
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/dog2.jpg" class="img-responsive" alt="Cinque Terre">

						<div class="person-contents">
							<h2 class="mb-0"><a href="#">技術長:馬新傑</a></h2>
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/dog3.jpg" class="img-responsive" alt="Cinque Terre">

						<div class="person-contents">
							<h2 class="mb-0"><a href="#">組員:陳韋翰</a></h2>
	...
	<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/dog4.jpg" class="img-responsive" alt="Cinque Terre">

						<div class="person-contents">
					<h2 class="mb-0"><a href="#">組員:康芷婷</a></h2>
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/dog5.jpg" class="img-responsive" alt="Cinque Terre">

						<div class="person-contents">
					<h2 class="mb-0"><a href="#">組員:林文琪</a></h2>
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						...
						<img src="images/dog6.jpg"  class="img-responsive" alt="Cinque Terre" >

						<div class="person-contents">
							<h2 class="mb-0"><a href="#">組員:鍾思雅</a></h2>
